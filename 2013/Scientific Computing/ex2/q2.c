...
int main(void){
	...
	fprintf(answers, hPrint, "N", "max psi", "x max psi", "y max psi", "psi=0 t", "sweeps", "psi interp t", "sweeps");
	...
	for(n = 1; n <= numRuns; n++){
		...
		fprintf(answers, rPrint, N/2, results[0], results[1], results[2], times[0], results[3], times[1], results[4]);
